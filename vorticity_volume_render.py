...
tfh.set_bounds((0.01, 15))
tfh.build_transfer_function()

#tfh.tf.add_gaussian(np.log10(9.5e-4), args.frac_sigma**2, plasma(1., args.alpha))
tfh.tf.add_gaussian(np.log10(10), 2*args.vort_sigma**2, plasma(1., args.alpha))
tfh.tf.add_gaussian(np.log10(6), args.vort_sigma**2, plasma(.5, args.alpha))
#tfh.tf.add_gaussian(np.log10(4), args.vort_sigma**2, plasma(.25, args.alpha))
tfh.tf.add_gaussian(np.log10(2), args.vort_sigma**2, plasma(0.0, args.alpha/20))
